...
import { isBase58, decodeBase58 } from '@mailchain/encoding';
import { Prefix, prefix } from './const.js';
...
function validateTezosAddress(address) {
    ...
    else if (address.slice(0, 3) !== Prefix.TZ1 &&
...
export { tezosAddressFromPublicKey, validateTezosAddress };
