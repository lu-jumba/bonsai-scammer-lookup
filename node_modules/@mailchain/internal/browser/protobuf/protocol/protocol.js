...
const protocol = $root.protocol = (() => {
    ...
    protocol.ECDHKeyBundle = (function() {
        ...
        ECDHKeyBundle.decode = function decode(reader, length) {
            ...
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.ECDHKeyBundle();
        ...
        /**
         * Gets the default type url for ECDHKeyBundle
         * @function getTypeUrl
         * @memberof protocol.ECDHKeyBundle
         * @static
    ...
    protocol.X3DHKeyBundle = (function() {
        ...
        X3DHKeyBundle.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.X3DHKeyBundle();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        X3DHKeyBundle.toObject = function toObject(message, options) {
            ...
            if (message.keyExchangeMethod != null && message.hasOwnProperty("keyExchangeMethod"))
                object.keyExchangeMethod = options.enums === String ? $root.protocol.KeyExchangeMethod[message.keyExchangeMethod] === undefined ? message.keyExchangeMethod : $root.protocol.KeyExchangeMethod[message.keyExchangeMethod] : message.keyExchangeMethod;
            if (message.publicMessagingKey != null && message.hasOwnProperty("publicMessagingKey"))
                object.publicMessagingKey = options.bytes === String ? $util.base64.encode(message.publicMessagingKey, 0, message.publicMessagingKey.length) : options.bytes === Array ? Array.prototype.slice.call(message.publicMessagingKey) : message.publicMessagingKey;
            return object;
        };
        ...
        /**
         * Gets the default type url for X3DHKeyBundle
         * @function getTypeUrl
         * @memberof protocol.X3DHKeyBundle
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
    ...
    protocol.Envelope = (function() {
        ...
        Envelope.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.Envelope();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
    ...
    protocol.Delivery = (function() {
        ...
        Delivery.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.Delivery();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        /**
         * Gets the default type url for Delivery
         * @function getTypeUrl
         * @memberof protocol.Delivery
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
...
export { $root as default, protocol };
