...
var mail = require('../receiving/mail/mail.js');
...
class MessageSync {
    ...
    static create(sdkConfig, keyRing, mailboxOperations, axiosInstance = axios.create()) {
        return new MessageSync(sdkConfig, mail.MailReceiver.create, keyRing, mailboxOperations, axiosInstance);
    }
        ...
        for (const messageResult of messageResults) {
            ...
            if (savedMessages && savedMessages.length > 0) {
                ...
                await receiver
                    ...
                    .then(() => {
                    console.debug(`Successfully confirmed delivery message hash ${encoding.encodeHex(messageResult.deliveryRequestHash)}`);
                })
                    .catch((e) => console.warn(`Failed saving received message with hash ${encoding.encodeHex(messageResult.deliveryRequestHash)}`, e));
            }
        }
