		...
		new MagicLinkStrategy(
			...
			async (user, token) => {
				...
				var msg = {
					...
					subject: 'Sign in to Bonsai Lookup!',
					content: {
						text: 'Hello! Click the link below to finish signing in to Bonsai Lookup!.\r\n\r\n' + link,
						html:
							'<h3>Hello!</h3><p>Click the link below to finish signing in to Bonsai Lookup!.</p><p><a href="' +
							link +
							'">Sign in</a></p>',
					},
				};
